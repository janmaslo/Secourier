...
function encode(input) {
    if (Array.isArray(input)) {
        ...
        var buf = concatBytes.apply(void 0, output);
...
function decode_RLP(input, stream) {
...
var cachedHexes = Array.from({ length: 256 }, function (_v, i) { return i.toString(16).padStart(2, '0'); });
